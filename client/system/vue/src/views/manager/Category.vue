<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="请输入货物种类查询"></el-input>
    ...
    <el-dialog name="货物分类信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
